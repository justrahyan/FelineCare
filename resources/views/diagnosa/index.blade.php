...
<div class="max-w-3xl mx-auto px-2 md:px-0 mt-6 md:mt-12" 
     x-data="{ 
        ...
        submitForm() {
            this.loading = true;
            // Gunakan timeout sedikit biar animasinya sempat terlihat
            setTimeout(() => {
                this.$refs.formDiagnosa.submit();
            }, 1000);
        }
     }">
    ...
    <div x-show="loading" x-cloak class="fixed inset-0 z-[99] flex items-center justify-center bg-white/90 backdrop-blur-md">
        <div class="text-center">
            ...
            <h2 class="text-xl font-black text-slate-800 tracking-tight">Menganalisis Gejala...</h2>
            <p class="text-slate-400 text-[10px] mt-2 font-black uppercase tracking-[0.2em] animate-pulse">Memproses Algoritma Certainty Factor</p>
        </div>
    </div>

    <div x-show="!loading">
        <form x-ref="formDiagnosa" action="{{ route('diagnosa.hitung') }}" method="POST" @submit.prevent="submitForm">
            @csrf
