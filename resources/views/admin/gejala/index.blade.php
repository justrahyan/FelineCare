    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden text-sm">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-slate-700 font-medium">
                ...
                <tr class="border-t border-slate-50 hover:bg-slate-50/50 transition text-sm">
                    ...
                    <td class="p-6 text-center">
                        <div class="flex justify-center gap-2">
                            <a href="{{ route('admin.gejala.edit', $g->id_gejala) }}" class="p-2 bg-amber-50 text-amber-600 rounded-lg hover:bg-amber-100 transition">
