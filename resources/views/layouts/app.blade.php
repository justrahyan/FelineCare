...
<body class="bg-emerald-50 text-slate-900">
    <nav class="bg-white/80 backdrop-blur-md shadow-sm border-b border-emerald-100 py-3 md:py-4 sticky top-0 z-50">
        <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
            <a href="/" class="transition hover:opacity-80">
                <img src="{{ asset('img/logo/logo.png') }}" alt="FelineCare Logo" class="h-8 md:h-10 w-auto">
            </a>
