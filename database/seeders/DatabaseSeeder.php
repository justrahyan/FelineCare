...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rules = [
            // P01 (Feline Infectious Peritonitis)
            ['P01', 'G01', 0.4, 0.6], ['P01', 'G02', 0.2, 0.8], ['P01', 'G04', 0.8, 0.2], ['P01', 'G15', 0.8, 0.2],

            // P02 (Feline Panleukopenia)
            ['P02', 'G01', 0.4, 0.6], ['P02', 'G03', 0.2, 0.8], ['P02', 'G12', 0.8, 0.2], ['P02', 'G14', 0.8, 0.2],

            // P03 (Feline Calicivirus)
            ['P03', 'G09', 0.8, 0.2], ['P03', 'G10', 0.8, 0.2],

            // P04 (Feline Viral Rhinotracheitis)
            ['P04', 'G06', 0.8, 0.2], ['P04', 'G07', 0.8, 0.2], ['P04', 'G08', 0.8, 0.2], ['P04', 'G24', 0.8, 0.2], ['P04', 'G25', 0.6, 0.4],

            // P05 (Scabies / Kudis)
            ['P05', 'G16', 0.8, 0.2], ['P05', 'G18', 0.8, 0.2], ['P05', 'G19', 0.8, 0.2], ['P05', 'G20', 0.6, 0.4],

            // P06 (Ringworm / Jamur)
            ['P06', 'G17', 0.8, 0.2], ['P06', 'G18', 0.8, 0.2],

            // P07 (Otitis External)
            ['P07', 'G21', 0.6, 0.4], ['P07', 'G22', 0.6, 0.4], ['P07', 'G23', 1.0, 0.0],

            // P08 (Helminthiasis / Cacingan)
            ['P08', 'G03', 0.2, 0.8], ['P08', 'G04', 0.6, 0.4], ['P08', 'G13', 0.6, 0.4], ['P08', 'G15', 0.8, 0.2],

            // P09 (Feline Chlamydiosis)
            ['P09', 'G01', 0.4, 0.6], ['P09', 'G03', 0.2, 0.8], ['P09', 'G24', 0.8, 0.2], ['P09', 'G25', 0.8, 0.2],

            // P10 (Ektoparasit / Kutu)
            ['P10', 'G16', 0.8, 0.2], ['P10', 'G17', 1.0, 0.0], ['P10', 'G19', 0.6, 0.4],

            // P11 (Enteritis / Radang Usus)
            ['P11', 'G01', 0.4, 0.6], ['P11', 'G02', 0.2, 0.8], ['P11', 'G03', 0.2, 0.8], ['P11', 'G04', 0.8, 0.2], ['P11', 'G05', 0.8, 0.2], ['P11', 'G12', 0.2, 0.8], ['P11', 'G13', 0.8, 0.2],

            // P12 (Rabies)
            ['P12', 'G01', 0.8, 0.2], ['P12', 'G02', 0.0, 1.0], ['P12', 'G03', 0.0, 1.0], ['P12', 'G04', 0.0, 1.0], ['P12', 'G05', 0.6, 0.4], ['P12', 'G10', 1.0, 0.0],

            // P13 (Gastritis / Radang Perut)
            ['P13', 'G03', 0.8, 0.2], ['P13', 'G12', 0.8, 0.2],
